...
build_llamacpp() {
    ...
    # build from an older LLAMACPP_PIN (e.g. before streaming+tools support
    # was added) would otherwise be reused forever, silently, no matter how
    # often the pin gets bumped in this file.
